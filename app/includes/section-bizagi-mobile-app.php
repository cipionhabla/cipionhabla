...
<div class="design-thinking">
  <a href="includes/page-understand.html" rel="modal:open" data-modal class="design-thinking__item">
    <svg viewBox="0 0 96 96"><use xlink:href="#icon-understand" /></svg>
    <p>Understand</p>
  </a>
  <a href="includes/page-explore.html" rel="modal:open" data-modal class="design-thinking__item">
    <svg viewBox="0 0 96 96"><use xlink:href="#icon-explore" /></svg>
    <p>Explore</p>
  </a>
  <a href="includes/page-materialize.html" rel="modal:open" data-modal class="design-thinking__item">
