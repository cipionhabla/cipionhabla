...
<div class="work-process">
  <a href="includes/page-understand.html" rel="modal:open" data-modal class="work-process__item">
    <svg viewBox="0 0 96 96"><use xlink:href="#icon-understand" /></svg>
    <p>Understand</p>
  </a>
  <a href="includes/page-explore.html" rel="modal:open" data-modal class="work-process__item">
    <svg viewBox="0 0 96 96"><use xlink:href="#icon-explore" /></svg>
    <p>Explore</p>
  </a>
  <a href="includes/page-materialize.html" rel="modal:open" data-modal class="work-process__item">
    <svg viewBox="0 0 96 96"><use xlink:href="#icon-materialize" /></svg>
    <p>Materialize</p>
  </a>
</div>
<h4>Conclusion</h4>
<p class="space-stack--s">After a couple of weeks of user research, analysis and redesign, I was able to validate the assumptions and changes I had made. I did this by testing my clickable prototype with 5 new users. The results are:</p>
<table>
    <tbody>
      <tr>
      ...
      <tr>
        ...
        <td>
          <svg viewBox="0 0 96 96" class="table-icon"><use xlink:href="#icon-user-happy" /></svg>
          <svg viewBox="0 0 96 96" class="table-icon"><use xlink:href="#icon-user-sad" /></svg>
          <svg viewBox="0 0 96 96" class="table-icon"><use xlink:href="#icon-user-sad" /></svg>
          <svg viewBox="0 0 96 96" class="table-icon"><use xlink:href="#icon-user-sad" /></svg>
          <svg viewBox="0 0 96 96" class="table-icon"><use xlink:href="#icon-user-sad" /></svg>
        </td>
      ...
      <tr>
        <th scope="row">Ability to send activities quickly</th>
        <td>
          <svg viewBox="0 0 96 96" class="table-icon"><use xlink:href="#icon-user-happy" /></svg>
          <svg viewBox="0 0 96 96" class="table-icon"><use xlink:href="#icon-user-happy" /></svg>
          <svg viewBox="0 0 96 96" class="table-icon"><use xlink:href="#icon-user-sad" /></svg>
      ...
      <tr>
        <th scope="row">Switch between different features</th>
        <td>
          <svg viewBox="0 0 96 96" class="table-icon"><use xlink:href="#icon-user-happy" /></svg>
          <svg viewBox="0 0 96 96" class="table-icon"><use xlink:href="#icon-user-happy" /></svg>
          <svg viewBox="0 0 96 96" class="table-icon"><use xlink:href="#icon-user-sad" /></svg>
      ...
      <tr>
        <th scope="row">Switch between different projects</th>
        <td>
          <svg viewBox="0 0 96 96" class="table-icon"><use xlink:href="#icon-user-happy" /></svg>
          <svg viewBox="0 0 96 96" class="table-icon"><use xlink:href="#icon-user-sad" /></svg>
          <svg viewBox="0 0 96 96" class="table-icon"><use xlink:href="#icon-user-sad" /></svg>
      ...
      <tr>
        <th scope="row">Ability to know what is going on the app</th>
        <td>
          <svg viewBox="0 0 96 96" class="table-icon"><use xlink:href="#icon-user-happy" /></svg>
          <svg viewBox="0 0 96 96" class="table-icon"><use xlink:href="#icon-user-happy" /></svg>
          <svg viewBox="0 0 96 96" class="table-icon"><use xlink:href="#icon-user-happy" /></svg>
